                  ...
                  <div class="top_panel_title top_panel_style_1  title_present scheme_original">
                     <div class="top_panel_title_inner top_panel_inner_style_1 breadcrumbs_present_inner">
                        <div class="content_wrap">
                           <h1 class="page_title">Suscripci&oacute;n realizada</h1>
                           <div class="breadcrumbs"><a class="breadcrumbs_item home" href="index.php">Inicio</a>
                              <span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Suscripci&oacute;n</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="content">
                     <article class="post_item post_item_404">
                        <div class="post_content">
                           ...
                           <h2 class="page_subtitle">Tu suscripcion ha sido realizada</h2>
                           <p class="page_description">
                              Muy pronto recibiras las novedades que tenemos para ti. 
