...
<html lang="en-US" class="scheme_original">
	<head>
		...
		<title>Publica tus Propiedades - Trialty</title>
										...
										<ul id="menu_main" class="menu_main_nav">
											...
											<li class="menu-item current-menu-parent menu-item-has-children">
												...
												<ul class="sub-menu">
													...
													<li class="menu-item current-menu-item"><a href="pricing.html">Pricing</a></li>
												</ul>
											</li>
											<li class="menu-item menu-item-has-children">
												<a href="#">Listing</a>
						...
						<div class="top_panel_title top_panel_style_1  title_present scheme_original">
							<div class="top_panel_title_inner top_panel_inner_style_1 breadcrumbs_present_inner">
								<div class="content_wrap">
									<h1 class="page_title">Pricing</h1>
									<div class="breadcrumbs"><a class="breadcrumbs_item home" href="index.html">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Pricing</span></div>
								</div>
							-->
							</div>
						</div>
					...
					<div class="sc_section">
						<div class="content_wrap">
							<div class="sc_content content_wrap margin_top_xlarge margin_bottom_xlarge">
								<h4 class="sc_title margin_top_null margin_bottom_medium">Planes de Publicaci&oacute;n</h4>
								<div class="columns_wrap sc_columns">
									<div class="column-1_3 sc_column_item">
										<div class="sc_price_block sc_price_block_style_1">
											<div class="sc_price_block_title"><span>Personal</span></div>
											<div class="sc_price_block_money">
												<div class="sc_price">
													<span class="sc_price_currency">US$</span>
													<span class="sc_price_money"><?php echo $precio_personal; ?></span>
													<span class="sc_price_period">mensual</span>
												</div>
											</div>
											<div class="sc_price_block_description"><?php echo $personal; ?><!--No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security--></div>
											<div class="sc_price_block_link"><a href="contacto.php?plan=personal" class="sc_button sc_button_box sc_button_style_style3">Solicitar</a></div>
										</div>
									</div>
									<div class="column-1_3 sc_column_item">
										<div class="sc_price_block sc_price_block_style_2">
											<div class="sc_price_block_title"><span>Business</span></div>
											<div class="sc_price_block_money">
												<div class="sc_price">
													<span class="sc_price_currency">US$</span>
													<span class="sc_price_money"><?php echo $precio_business; ?></span>
													<span class="sc_price_period">mensual</span>
												</div>
											</div>
											<div class="sc_price_block_description"><?php echo $business; ?><!--No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security--></div>
											<div class="sc_price_block_link"><a href="contacto.php?plan=business" class="sc_button sc_button_box sc_button_style_style3">Solicitar</a></div>
										</div>
									</div>
									<div class="column-1_3 sc_column_item">
										<div class="sc_price_block sc_price_block_style_1">
											<div class="sc_price_block_title"><span>Premium</span></div>
											<div class="sc_price_block_money">
												<div class="sc_price">
													<span class="sc_price_currency">US$</span>
													<span class="sc_price_money"><?php echo $precio_premium; ?></span>
													<span class="sc_price_period">mensual</span>
												</div>
											</div>
											<div class="sc_price_block_description"><?php echo $premium; ?><!--No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security--></div>
											<div class="sc_price_block_link"><a href="contacto.php?plan=premium" class="sc_button sc_button_box sc_button_style_style3">Solicitar</a></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="content_wrap">
							<div class="sc_section margin_top_xlarge margin_bottom_xlarge">
								<div class="sc_section_inner">
									<h4 class="sc_title margin_bottom_small">Have a Questions?</h4>
									<div class="columns_wrap sc_columns">
										<div class="column-1_2 sc_column_item">
											<h5 class="sc_title margin_bottom_tiny">Where do I get started?</h5>
										...
										<div class="column-1_2 sc_column_item">
											<h5 class="sc_title margin_bottom_tiny">Do I have to pay for each property I want to view?</h5>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et aliquet dui. Sed nec massa commodo, bibendum mi et, tempus dolor. Vestibulum feugiat ultrices vehicula. Proin sed odio dui. Donec ligula nunc, molestie id nulla feugiat, faucibus bibendum odio.</p>
										</div>
									</div>
									<div class="columns_wrap sc_columns">
										<div class="column-1_2 sc_column_item">
											<h5 class="sc_title margin_top_medium margin_bottom_tiny">What happens at the end of the paid period?</h5>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et aliquet dui. Sed nec massa commodo, bibendum mi et, tempus dolor. Vestibulum feugiat ultrices vehicula. Proin sed odio dui. Donec ligula nunc, molestie id nulla feugiat, faucibus bibendum odio.</p>
										</div>
										<div class="column-1_2 sc_column_item">
											<h5 class="sc_title margin_top_medium margin_bottom_tiny">How can I cancel my subscription?</h5>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et aliquet dui. Sed nec massa commodo, bibendum mi et, tempus dolor. Vestibulum feugiat ultrices vehicula. Proin sed odio dui. Donec ligula nunc, molestie id nulla feugiat, faucibus bibendum odio.</p>
										</div>
									</div>
								</div>
	...
	-->
		...
		<script type='text/javascript' src='js/custom/plugins.js'></script><script type='text/javascript' src='js/custom/messages.js'></script>
