...
<html lang="en-US" class="scheme_original">
   <head>
      ...
      <title>Page not found &#8211; Estate &#8211; Real estate template</title>
                                    ...
                                    <ul class="sub-menu">
                                       <li class="menu-item current-menu-ancestor menu-item-has-children">
                                          ...
                                          <ul class="sub-menu">
                                             ...
                                             <li class="menu-item current-menu-item"><a href="404.html">Page 404</a></li>
                  ...
                  <div class="top_panel_title top_panel_style_1  title_present scheme_original">
                     <div class="top_panel_title_inner top_panel_inner_style_1 breadcrumbs_present_inner">
                        <div class="content_wrap">
                           <h1 class="page_title">URL no funciona</h1>
                           <div class="breadcrumbs"><a class="breadcrumbs_item home" href="index.php">Inicio</a>
                              <span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Error 404</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="content">
                     <article class="post_item post_item_404">
                        <div class="post_content">
                           ...
                           <h2 class="page_subtitle">La pagina que busca no existe</h2>
                           <p class="page_description">
                              No puedes encontrar lo que necesitas?<br> Comience desde <a href="index.php">Nuestra pagina principal</a>. 
                           </p>
                        </div>
                     </article>
                  </div>
