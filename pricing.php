...
<html lang="en-US" class="scheme_original">
	<head>
		...
		<title>Pricing &#8211; Estate &#8211; Real estate template</title>
					...
					<div class="sc_section">
						<div class="content_wrap">
							<div class="sc_content content_wrap margin_top_xlarge margin_bottom_xlarge">
								<h4 class="sc_title margin_top_null margin_bottom_medium">Pricing tables</h4>
										...
										<div class="sc_price_block sc_price_block_style_1">
											...
											<div class="sc_price_block_money">
												<div class="sc_price">
													...
													<span class="sc_price_money">29.99</span>
													<span class="sc_price_period">monthly</span>
												</div>
											</div>
											<div class="sc_price_block_description">No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security</div>
											<div class="sc_price_block_link"><a href="#" class="sc_button sc_button_box sc_button_style_style3">example</a></div>
										</div>
									</div>
									<div class="column-1_3 sc_column_item">
										<div class="sc_price_block sc_price_block_style_2">
											...
											<div class="sc_price_block_money">
												<div class="sc_price">
													<span class="sc_price_currency">$</span>
													<span class="sc_price_money">59.99</span>
													<span class="sc_price_period">monthly</span>
												</div>
											</div>
											<div class="sc_price_block_description">No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security</div>
									...
									<div class="column-1_3 sc_column_item">
										<div class="sc_price_block sc_price_block_style_1">
											...
											<div class="sc_price_block_money">
												<div class="sc_price">
													<span class="sc_price_currency">$</span>
													<span class="sc_price_money">99.00</span>
													<span class="sc_price_period">monthly</span>
												</div>
											</div>
											<div class="sc_price_block_description">No support<br /> No update<br /> 1 user acces<br /> 32 MB bandwidth<br /> 1 user only<br /> No Security</div>
