                  ...
                  <div class="sc_emailer">
                     ...
                     <div class="sc_emailer_content">
                        <form class="sc_emailer_form" method="post" action="suscripcion.php">
                          ...
                          <!-- <input type="submit" class="sc_emailer_button sc_button sc_button_box sc_button_style_style3" title="Submit">suscribete</a> -->
                        </form>
                     </div>
                     <div class="cL"></div>
                  </div>
                  ...
                  <div class="content_wrap">
                     <div class="columns_wrap">
                        <div class="column-1_4 show_logo_footer">
                           <div class="logo">
                              <a href="index.html"><img src="images/logo_trialty.png" alt=""></a>
                           </div>
                        </div>
                        ...
                        <div class="column-1_4">
                           ...
                           <div class="sc_socials sc_socials_type_icons sc_socials_size_small">
                              ...
                              <div class="sc_socials_item" style="background-image: url('images/pinterest2.png'); background-repeat: no-repeat"><a href="<?php echo $pinterest; ?>" target="_blank" class="social_icons"><span class="icon-pinterest"></span></a></div>
                               <div class="sc_socials_item"><a href="<?php echo $linkedin; ?>" target="_blank" class="social_icons"><span class="icon-linkedin"></span></a></div>
               ...
               <div class="copyright_wrap_inner">
                  <div class="content_wrap">
                    ...
                    <!--    <li class="menu-item"><a href="#">Politicas de uso</a></li>
                        ...
                        <li class="menu-item"><a href="contacto.php?tema=publicidad">Publicidad</a></li>
                        <li class="menu-item"><a href="contacto.php">Contactanos</a></li>
                     </ul>
