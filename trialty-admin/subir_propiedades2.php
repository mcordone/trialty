...
VALUES ('$nombre_propiedad','$tipo_compra','$moneda','$precio_rd','$precio_us','$precio_eur','$cantidad_habitacion','$bano','$parqueo','$jardin','$patio','$balcon','$terraza','$piscina','$gym','$area_social','$estudio','$family','$piso','$nivel','$descripcion','$metraje','$provincias','$sectores','$nombre2','$tipo','0','$slideshow', '$portada')", $con);
